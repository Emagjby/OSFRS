...
@section('content')
<h2>Export Daily Usage Report (CSV)</h2><br>
...
<script>
document.getElementById("csvExportForm").onsubmit = async (e) => {
    e.preventDefault();

    const date = document.getElementById("date").value;

    let url = `/api/statistics/export/csv`;
    ...
    link.download = "usage_report.csv";
    link.click();
};
</script>
